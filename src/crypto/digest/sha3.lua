...
local function sha3_256(data)
	return keccakHash(1088, 256, data, "sha3")
end
local function sha3_512(data)
	return keccakHash(576, 512, data, "sha3")
end
local function keccak256(data)
	return keccakHash(1088, 256, data, "keccak")
end
local function keccak512(data)
	return keccakHash(576, 512, data, "keccak")
end
