--[[
	Adds HB patch message sending for when balances are modified.

    - load code in
    - Initiaize HB via ao.send({device = "patch@1.0", balances = { device = "trie@1.0" } })

    - After, in a seperate message, can call the Patch-Hyperbeam-Balances action to send the balances and hydrate the HB state

	Reviewers: Ariel, Atticus
]]

-- Copied from aos-bundled.lua after building
-- module: ".src.hb"
